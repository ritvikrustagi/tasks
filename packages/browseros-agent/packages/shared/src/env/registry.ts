...
export const ENV_REGISTRY: readonly EnvKeySpec[] = [
  ...
  {
    key: 'VITE_RESEARCH_URL',
    section: 'app',
    description: 'Research workspace URL opened from browser navigation.',
    secret: false,
    schema: urlSchema,
    modes: {
      development: { value: 'http://127.0.0.1:4318' },
      production: { value: 'http://127.0.0.1:4318' },
    },
  },
  {
